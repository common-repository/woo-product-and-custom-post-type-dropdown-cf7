...
* Description: This plugin allows create Product And Custom Post type Dropdown CF7 plugin.
* Version: 1.0
* Copyright: 2020
* Text Domain: woo-product-and-custom-post-type-dropdown-cf7
...
if (!defined('CF7WPAPLOC_DOMAIN')) {
   define('CF7WPAPLOC_DOMAIN', 'woo-product-and-custom-post-type-dropdown-cf7');
}
...
if (!class_exists('CF7WPAPLOC_main')) {
	add_action('plugins_loaded', array('CF7WPAPLOC_main', 'CF7WPAPLOC_instance'));
      ...
      function init() {
         ...
         include_once('admin/cf7wpaploc_kit.php');
      ...
      function CF7WPAPLOC_plugin_row_meta( $links, $file ) {
         if ( CF7WPAPLOC_BASE_NAME === $file ) {
            $row_meta = array(
               'rating'    =>  '<a href="https://www.xeeshop.com/product-and-custom-post-type-dropdown-cf7/" target="_blank">Documentation</a> | <a href="https://www.xeeshop.com/support-us/?utm_source=aj_plugin&utm_medium=plugin_support&utm_campaign=aj_support&utm_content=aj_wordpress" target="_blank">Support</a> | <a href="https://wordpress.org/support/plugin/woo-product-and-custom-post-type-dropdown-cf7/reviews/?filter=5" target="_blank"><img src="'.CF7WPAPLOC_PLUGIN_DIR.'/images/star.png" class="cf7paplist_rating_div"></a>',
            );
...
add_action( 'plugins_loaded', 'cf7wpaploc_load_textdomain' );
 
function cf7wpaploc_load_textdomain() {
    load_plugin_textdomain( 'woo-product-and-custom-post-type-dropdown-cf7', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' ); 
}
function cf7wpaploc_load_my_own_textdomain( $mofile, $domain ) {
...
add_filter( 'load_textdomain_mofile', 'cf7wpaploc_load_my_own_textdomain', 10, 2 );